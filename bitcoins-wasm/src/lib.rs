//! Bitcoins crate with wasm-bindings. This crate puts JS-friendly wrappers around the
//! bitcoins crate. The wrappers implement passthrough methods for most functionality, and the
...
//!
//! ```compile_fail
//! const btc = require('@summa-tx/bitcoins-wasm');
//!
//! const addr = "bc1q....";
//!
